...
import { TrendingUp, TrendingDown, Minus, ChevronRight, ChevronDown, Zap, ShieldAlert, Clock, AlertTriangle, Users, Target } from "lucide-react";
...
export default function RosterSection({ athletes = [] }) {
