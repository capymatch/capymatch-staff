...
export function CoachLogInteraction({ athleteId, athleteName, onSaved, onCancel }) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4" style={{ background: "rgba(0,0,0,0.6)", backdropFilter: "blur(12px)" }} data-testid="coach-log-overlay">
      <div className="w-full max-w-[520px] rounded-lg overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-200 flex flex-col"
