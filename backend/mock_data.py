...
def generate_upcoming_events():
    ...
    events = [
        # Past event — needs debrief
        {
            ...
            "athlete_ids": ["athlete_5", "athlete_9"],
            "school_ids": ["stanford", "virginia", "michigan"],
            "checklist": [
        ...
        # Upcoming events
        {"id": "event_1", "name": "College Exposure Camp", "type": "camp",
         "daysAway": 2, "location": "Irvine, CA",
         "expectedSchools": 10, "prepStatus": "in_progress", "status": "upcoming",
         "athlete_ids": ["athlete_3", "athlete_7", "athlete_9"],
         "school_ids": ["ucla", "stanford", "usc", "virginia", "michigan"],
         "checklist": [
             {"id": "check_1", "label": "Confirm athlete attendance", "completed": True},
             {"id": "check_2", "label": "Identify target school coaches attending", "completed": True},
             {"id": "check_3", "label": "Review highlight reels", "completed": False},
        ...
        {"id": "event_2", "name": "Spring Classic", "type": "tournament",
         "daysAway": 8, "location": "Las Vegas, NV",
         "expectedSchools": 14, "prepStatus": "not_started", "status": "upcoming",
         "athlete_ids": ["athlete_1", "athlete_5", "athlete_14"],
         "school_ids": ["duke", "unc", "georgetown", "usc", "virginia"],
